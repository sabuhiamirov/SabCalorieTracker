package com.sabcode.tracker_data.repository

import com.google.common.truth.Truth.assertThat
import com.sabcode.tracker_data.local.TrackerDao
import com.sabcode.tracker_data.remote.OpenFoodApi
import com.sabcode.tracker_data.remote.malformedFoodResponse
import com.sabcode.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, valid response, returns result fail`() = runBlocking {
        mockWebServer.enqueue(
            MockResponse()
                .setResponseCode(403)
                .setBody(validFoodResponse)
    ...
    @Test
    fun `Search food, malformed response, returns result fail`() = runBlocking {
        mockWebServer.enqueue(
            MockResponse()
